import ffmpeg
import os
from transcribe.run import get_transcriptions_from_file
...
def process_raw_audio(filename: str):
    ...
    transcriptions = get_transcriptions_from_file(filename)
...
def process_file_audio(filename: str):
    transcriptions = get_transcriptions_from_file(filename)
